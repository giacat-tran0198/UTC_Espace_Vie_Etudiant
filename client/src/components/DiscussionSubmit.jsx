...
class DiscussionSubmit extends Component {
    state = {
        focused: false,
        content: undefined,
    ...
    uploadFile = () => {
        ...
        apiCall.postDiscussionFile(body).then((response) => {
                        ...
                        <div>
                            ...
                            <div className="text-right mt-1">
                                <ButtonWithProgress
                                    ...
                                    onClick={this.onClickDiscussion}
...
export default connect(mapStateToProps)(DiscussionSubmit);